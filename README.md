<div align="center">
  <a href="https://insforge.dev">
    <picture>
      ...
      <img src="assets/logo-dark.svg" alt="InsForge" width="35%">
    </picture>
  </a>

  <p>
    <h3 style="margin: 5px 0 10px 0; border: none;">The Backend Built for Agentic Development</h3>
  </p>
...
<p style="max-width: 900px; margin: 10px auto; text-align: left;">InsForge is a backend development platform built for AI coding agents. It exposes backend primitives like databases, auth and storage through a semantic layer that agents can understand, reason about, and operate end to end.</p>
