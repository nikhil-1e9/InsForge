<div align="center">
  ...
  <p style="max-width: 900px; margin: 10px auto; text-align: left;">InsForge provides a semantic layer for AI agents to autonomously operate backend primitives like databases, auth, and storage end-to-end
  </p>
</div>
